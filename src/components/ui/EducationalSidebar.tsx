...
const EDUCATIONAL_CONTENT: Record<string, { icon: string; what: string; why: string; fact: string }> = {
  'input': {
    icon: '📝',
  ...
  'key-schedule': {
    ...
    fact: 'The shift schedule (1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1) was carefully chosen to maximize diffusion.'
  },
  'feistel': {
    icon: '🔄',
